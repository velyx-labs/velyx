...
<x-docs.layout :title="$title">
    ...
    <div class="grid gap-4 md:grid-cols-3">
        <x-ui.card class="p-5">
            ...
            <x-ui.button href="{{ route('docs.page', 'quick-start') }}" wire:navigate variant="outline" size="sm" class="mt-5" iconRight="arrow-right">Quick start</x-ui.button>
        </x-ui.card>
        ...
        <x-ui.card class="p-5">
            ...
            <x-ui.button href="{{ route('docs.components.show', 'button') }}" wire:navigate variant="outline" size="sm" class="mt-5" iconRight="arrow-right">View button</x-ui.button>
        </x-ui.card>
